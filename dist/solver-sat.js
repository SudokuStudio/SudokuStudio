...
export function cantAttempt(board) {
...
export async function solve(board, maxSolutions, onSolutionFoundOrComplete, cancellationToken = {}) {
...
export async function solveTrueCandidates(board, onComplete, cancellationToken = {}) {
    var _a;
    const pbLib = await pbLibPromise;
    const size = board.grid.width;
    const context = {
