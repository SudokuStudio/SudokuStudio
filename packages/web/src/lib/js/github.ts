...
export const URL_REPORT_BUG = URL_NEW_ISSUE
    + '?labels=%F0%9F%90%9E%20bug&template=bug_report.yml&title=%F0%9F%90%9E+Bug%3A+';
export const URL_REQUEST_FEATURE = URL_NEW_ISSUE
    + '?labels=%E2%9C%A8%20enhancement&template=feature_request.yml&title=%E2%9C%A8+Feature%3A+';
