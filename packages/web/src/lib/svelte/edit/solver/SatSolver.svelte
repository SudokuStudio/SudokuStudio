<script lang="ts">
    ...
    import { boardState, getTypeForElementKey, setCellValue } from '$lib/js/board';
    import type { Diff } from '@sudoku-studio/state-manager/src';
    import { MARK_TYPES } from '$lib/js/user';
    import { pushHistoryList } from '$lib/js/history';
    import { SatSolver } from '$lib/js/solver/satSolver';
