...
export type Idx<_TAG extends Geometry> = number;
...
export declare namespace schema {
    ...
    export interface ColorsElement extends AbstractElement {
        type: 'colors';
        value?: IdxMap<Geometry.CELL, { [K: string]: true }>;
    }
    ...
    export interface ConsecutiveElement extends AbstractElement {
        type: 'consecutive';
        value?: { orth: boolean; diag: boolean };
    }
    ...
    export interface KillerElement extends AbstractElement {
        type: 'killer';
        value?: { [K: string]: { sum?: number; cells: IdxBitset<Geometry.CELL> } };
    }
    ...
    export interface QuadrupleElement extends AbstractElement {
        type: 'quadruple';
        value?: IdxMap<Geometry.CORNER, true | { 0?: number; 1?: number; 2?: number; 3?: number }>;
    }
