import type { schema, ArrayObj, IdxBitset, Geometry } from '@sudoku-studio/schema';
...
function defaultRegions(
    ...
    boxWidth: number = 3,
    boxHeight: number = 3,
): ArrayObj<IdxBitset<Geometry.CELL>> {
...
export function createNewBoard(
    ...
    const board: schema.Board = {
        ...
        meta: { title: null, author: null, description: null },
        elements: {},
    };

    board.elements['1'] = createElement<schema.GridElement>('grid');
    board.elements['2'] = createElement<schema.GridRegionElement>(
        'gridRegion',
